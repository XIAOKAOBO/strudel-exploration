...
class LStrudel:
    ...
    def fit(self, train_set: pandas.DataFrame, test_set: pandas.DataFrame, method='predict_proba'):
        ...
        pred_prob_df = pandas.DataFrame(data=pred_prob, columns='lines_'+clf.classes_ + '_prob')
        pred_prob_df.fillna(0)

        # for item in pred_prob_df:
        #     print(pred_prob_df[item])

        test_set_with_line_prob = pandas.concat([test_set_line_profile, pred_prob_df.fillna(0), y_test.fillna(0)], axis=1)
...
#     #     print(item)    
#     # file_array = np.transpose(file_array)
...
#                                                 'derived_cell_coverage': f_derived_cell_coverage,
#                                                 'label': labels})
#     items = {'file_name': file_json_dict['file_name'],
#                                                 'sheet_name': file_json_dict['table_id'],
#                                                 'line_number': line_number,
#                                                 'line_position': f_line_position,
#                                                 'has_derived_keyword': f_kw_exist,
...
#                                                 'derived_cell_coverage': f_derived_cell_coverage,
#                                                 'label': labels}
#     # for item in lstrudel_feature_vector:
#     #     # if item != 'file_name' or item != 'sheet_name':
#     #     print(lstrudel_feature_vector[item])

#     # print('yes')
#     # print(lstrudel_feature_vector)
